...
const stats = [
  { name: 'Total Buku', stat: '71,897', previousStat: '70,946', change: '12%', changeType: 'increase' },
  { name: 'Total Pinjaman Buku', stat: '58.16%', previousStat: '56.14%', change: '2.02%', changeType: 'increase' },
  { name: 'Total Anggota', stat: '24.57%', previousStat: '28.62%', change: '4.05%', changeType: 'decrease' },
]
export default {
  components: {
    ArrowSmDownIcon,
