<template>
  <div class="bg-white overflow-hidden text-left">
      ...
      <div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
        ...
        <div class="mt-8 lg:mt-0">
          <div class="text-base max-w-prose mx-auto lg:max-w-none">
            <p class="text-lg text-gray-700">Sagittis scelerisque nulla cursus in enim consectetur quam. Dictum urna sed consectetur neque tristique pellentesque. Blandit amet, sed aenean erat arcu morbi.</p>
          </div>
          <div class="mt-5 prose prose-indigo text-gray-700 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
